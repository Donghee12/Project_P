    ...
    try:
        ...
        response = client.chat.completions.create(
            ...
            messages=[
                ...
                {"role": "user", "content": "Java 문제 1개를 생성하세요. 다음 주제 중 하나를 포함해야 합니다:"},
                {"role": "user", "content": (
                    "1. 데이터 구조 (배열, ArrayList, HashMap)\n"
                    "2. 문자열 처리 (String 조작, 정규 표현식)\n"
                    "3. 알고리즘 문제 (탐색, 정렬, 컬렉션 알고리즘)\n"
                    "4. 수학적 계산 (소수, 확률, 통계)\n"
                    "5. 클래스와 객체지향 프로그래밍 (상속, 다형성, 인터페이스)"
                    )}
            ]
        )
